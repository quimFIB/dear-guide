...
set — the launcher's policy governs and this file does not apply.
...
<the directory for pages>. A record is a synopsis that cites its page as its
source; the page names its record, so each leads to the other.

## Who closes a question

<one of:>

- the model decides and applies — the skill's default;
...
One at a time. First the smallest example that shows the tension, then a
recommendation with its cost, then a draft of the answer, the falsifier, the
source and what it opens. Then wait for the owner.

<anything this project adds or removes>

## Shelves

<area> — <what filing a question here means, and when one is taken up>

## Commits

The graph changes in the same commit as the work that changed it.
Message style: <…>
